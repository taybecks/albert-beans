  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center px-4 py-8 max-w-4xl mx-auto w-full">
        <h1 className="text-3xl font-bold mb-8 text-center animated-gradient-text">Select Your Elements</h1>
              ...
              {Object.keys(jumpElements).map((elementId) => {
                ...
                return (
                  <Button
                    key={elementId}
                    className={`px-8 py-3 ${
                      isSelected ? "btn-gradient-fill" : "btn-gradient-border"
                    }`}
        ...
        <div className="mt-12">
          <Button onClick={handleContinue} className="btn-gradient-fill px-12 py-5 text-lg font-bold">
